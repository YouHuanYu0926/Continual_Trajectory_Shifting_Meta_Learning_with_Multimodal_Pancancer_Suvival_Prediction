...
file_path = "FOMAMLPretrainoutput.txt"
...
def run_single_process():
    ...
    for i in range(1, FLAGS.train_steps + 1):
        ...
        if i % 1000 == 0:
            torch.save(survmodel.state_dict(), f"FOMAMLmodel_{i}_step.pth")

        print(f"FOMAML{i} step finish")

    torch.save(survmodel.state_dict(), "FOMAMLfinal_model.pth")
